...
class ESGroupTransformer(nn.Module):
    def __init__(
        self,
        *,
        group: Group,
        ...
        if True:
            LiftingSA = ESLiftConvAttention
            self.GroupSA = ESGroupConvAttention
        else:
    ...
    def forward(self, x):
        ...
        # print_memory_usage()
        # print(out.shape)
        # out = self.lifting_normalization(out)   #REIMPLEMENT THIS
        # print(x.shape)
        # out = self.Activation()(out)            #REIMPLEMENT THIS
